...
1. UMD says that they are aware that this doesn't represent all the different groups of races and groups them in a main category of “Races/Ethnicities with Small Sample Sizes.” This combines atleast 7 groups of people into one which could take away the individuality in the survey.

2. In the survey, it said how there is 12% of students/staff didn't report their ethnicity which makes me wonder why some people didn't report.
...
1. What is the range of weights in this dataset? 0.2298 to 3.386. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? If a respondent has a weight of 0.23 then that means they are underrepresented and if the weight is 3.04, that means they are overrepresented.

3. Why might some respondents be weighted more heavily than others? Some respondents are weighted more heavily than others because it depends on who they are asking in the survey and how many groups or individuals are in that group that is surveyed. There could be more of a specific type of group that is more prone in different areas than others depending on where or when the survey is done. If there is less of a group in the sample population then they will be underrepresented because there aren't a lot of those types of people in that area.
...
2. How might these differences affect reporting on likely voter turnout? The people who are more unlikely to not answer the survey are going to be more likely not to vote.This will affect reporting because then those people who don't do the survey and don't vote won't be accounted for in the data.

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? Those who respond to surveys and vote are more likely to be over-represented in the data compared to those who don't vote and don't answer surveys who will be underrepresented.
