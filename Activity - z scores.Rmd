...
There seems to be about 10 daily calls related to overdoses in Baltimore County. The most there has been in a day is 23 and the least has been one. The outlier is how there are numerous days where there are more calls than the mean which is about 10 a day.It's hard to see a pattern with this because there are so many different numbers.
...
If we look at the unusual days, it highlights the outliers which was a peak in October 2022. 10-04-2022 is very unususal because it has a z-score of 3.39 so it is unusual within the normal distribution. The other 17 days are considered unusual because of their z scores. There are 11 unusually high days and 7 unusually low days. This differs my answer from Task 3 because this shows only the top 95% as we can see from the z scores. Instead of having all the big numbers of data, this shows majority of the data.
...
Saturday experienced the highest number of overdose calls in Baltimore County.
...
Some potential angles you could use for reporting could be reporting on what days of the week seem to have more overdose calls or what days seem to be the least. Doing this you could dive into this subject and interview workers or people that live in Baltimore County and see why they think this is. You could also look into the top three days that have the highest calls and maybe find out why it was so high that day. This would also include going into Baltimore County and interviewing people because that could make the story a lot more impactful. This seems like something I would read myself and sounds very interesting.
