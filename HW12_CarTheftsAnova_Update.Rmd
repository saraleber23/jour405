...
**Task 2** Describe the results of calculating the rates for each period. What do they suggest?(3 points)
 ...
 The median rate doubled from the pre-spike to the post-spike from 22.2 to 46.2. It was even higher during the spike year which was 58.1. These results suggest that a short-term surge in car thefts happened during the spike year,then there was a decline but not to the full return from before but still lower.
...
"Dramatic Spike in Car Thefts Peak Around 2023"
...
- **Null Hypothesis (H0)**:   There is no significant difference in the mean of car theft rates between the three time periods.

- **Alternative Hypothesis (H1)**: There is a significant difference in the mean of car thefts between at least one of the time periods.
...
The ANOVA test showed an F-value of about 218 with a p-value of less than 0.001 which means that the result is highly statistically significant. Knowing this, it means we can reject the null hypothesis and say there are real differences in the average car theft rates between the three different time periods.
...
The three different time periods show a difference. The spike year shows a high mean rate and the pre and post spike periods are lower. Based on the Tukey test we can see where the error bar overlaps and where it doesn't showing us what's significant and whats not. The spike year is much higher and and the Confidence Interval doesn't overlap the others which means it is signicant. The pre-spike and post-spike are closer with some overlap which means they are not significant.

Headline: Car Theft Rates To Pre-Spike Levels After A 2023 Surge

Lede: After a large rise in car thefts during the 2023 spike year, the car theft rates in the post spike have dropped significantly. The pre-spike rate for car thefts was about 216.9 and then it spiked to about 573.4 but then went back down in the post spike period to about 418.8. Statistical anaylsis has shown there is no signficance between the pre and post spike periods, which could mean the theft rates have steadied after the temporary spike.